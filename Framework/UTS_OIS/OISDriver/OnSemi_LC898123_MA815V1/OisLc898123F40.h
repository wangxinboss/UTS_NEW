...
#define			StMeasFunc_PMC_SiFsCountF		0x0001 + StMeasFunc_PMC_UcCrossDetectB	// 0x04BC
...
#define FLASHROM_123F40		0xE07000	// Flash Memory I/F配置アド?ス
