...
public:
	...
	int GetGyroX(INT32 *X);
	int GetGyroY(INT32 *Y);
	...
	int HallCheck(float *fxMaxAcc,float *fyMaxAcc,float *fxLimit,float *fyLimit,void *fxy_raw_data);
	int ErCrossTalkData();
