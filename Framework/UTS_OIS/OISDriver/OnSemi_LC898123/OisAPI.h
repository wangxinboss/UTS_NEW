...
// __OIS_CMD_HEADER__	INT_16	WrHalLnData( UINT_8 );
 ...
 __OIS_CMD_HEADER__	UINT_32	MeasGain ( UINT_16	, UINT_16	 , UINT_32  );
  ...
  __OIS_CMD_HEADER__ UINT_8	WrADOOffsetData( void ) ;
 /* Flash Update */
...
// __OIS_FLSH_HEADER__	UINT_8	FlashDownload( UINT_8 , UINT_8 , UINT_8  );
 __OIS_FLSH_HEADER__	UINT_8	FlashUpdateF40( UINT_8 , DOWNLOAD_TBL *  );
 __OIS_FLSH_HEADER__    UINT_8 FlashDownloadF40_HOLITECH( UINT_8 chiperase, UINT_8 ModuleVendor, UINT_8 ActVer );
 ...
 __OIS_CMD_HEADER__	unsigned short HallCheck_ON123(float ACCURACY, unsigned short RADIUS, unsigned short DEGSTEP, unsigned short WAIT_MSEC1, unsigned short WAIT_MSEC2, unsigned short WAIT_MSEC3,
