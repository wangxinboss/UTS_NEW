...
{
	name = _T("OV13858");
	sensorType = Sensor_OV13858;
    sid_len = 16;

}

//-------------------------------------------------------------------------------------------------
int OV13858::do_prog_otp(int page, int addr, const void *data, int len)
{
	...
	int i = 0;
	char ReadOtpData[200];
	char BurnOtpData[200];
	char BurnData;
	int retrycount = 0;
	memset(ReadOtpData, 0, 200);
...
int OV13858::do_read_otp(int page, int addr, void *data, int len)
{
//	int otp_flag,i;
...
//-----------------------------------------------------------------------------
int OV13858::do_get_sid(uint8_t *id)
{
...
BOOL OV13858::GetSensorId(__out CString &strSensorId)
{
...
int OV13858::wb_writeback(uint8_t *regs, int len)
{
