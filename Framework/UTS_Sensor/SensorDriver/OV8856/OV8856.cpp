...
{
	name = _T("OV8856");
	sensorType = Sensor_OV8856;
    sid_len = 16;
}

#define BIT16_BIT8 2
//-------------------------------------------------------------------------------------------------
int OV8856::do_prog_otp(int page, int addr, const void *data, int len)
{
...
int OV8856::do_read_otp(int page, int addr, void *data, int len)
{
...
//-----------------------------------------------------------------------------
int OV8856::do_get_sid(uint8_t *id)
{
...
BOOL OV8856::GetSensorId(__out CString &strSensorId)
{
...
int OV8856::wb_writeback(uint8_t *regs, int len)
{
