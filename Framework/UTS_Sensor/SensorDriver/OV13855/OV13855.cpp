...
{
	name = _T("OV13855");
	sensorType = Sensor_OV13855;
    sid_len = 16;

}

//-------------------------------------------------------------------------------------------------
int OV13855::do_prog_otp(int page, int addr, const void *data, int len)
{
...
int OV13855::do_read_otp(int page, int addr, void *data, int len)
{
//	int otp_flag,i;
...
//-----------------------------------------------------------------------------
int OV13855::do_get_sid(uint8_t *id)
{
...
BOOL OV13855::GetSensorId(__out CString &strSensorId)
{
...
int OV13855::wb_writeback(uint8_t *regs, int len)
{
