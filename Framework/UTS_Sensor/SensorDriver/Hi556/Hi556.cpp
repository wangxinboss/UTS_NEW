...
//-------------------------------------------------------------------------------------------------
int Hi556::do_prog_otp(int page, int addr, const void *data, int len)
{
...
int Hi556::do_read_otp(int page, int addr, void *data, int len)
{
...
//-----------------------------------------------------------------------------
int Hi556::do_get_sid(uint8_t *id)
{
...
BOOL Hi556::GetSensorId(__out CString &strSensorId)
{
...
int Hi556::wb_writeback(uint8_t *regs, int len)
{
