...
{
	name = _T("OV16885");
	sensorType = Sensor_OV16885;
    sid_len = 16;

}

//-------------------------------------------------------------------------------------------------
int OV16885::do_prog_otp(int page, int addr, const void *data, int len)
{
	return SET_ERROR(SENSORDRIVER_ERROR_NOTSUPPORT);
}


int OV16885::do_read_otp(int page, int addr, void *data, int len)
{
	return SET_ERROR(SENSORDRIVER_ERROR_NOTSUPPORT);
}
//-----------------------------------------------------------------------------
int OV16885::do_get_sid(uint8_t *id)
{
...
BOOL OV16885::GetSensorId(__out CString &strSensorId)
{
...
int OV16885::wb_writeback(uint8_t *regs, int len)
{
