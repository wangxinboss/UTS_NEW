...
REWRITE:
	...
	for ( i=0;i<16;i++)
	{
		dev->i2c_write(BIT16_BIT8,0x3D00+i,0x00);  // clear OTP buffer, recommended use continuous write to accelarate
	}
...
//	unsigned char ReadOtpValue;
	...
	dev->i2c_write(BIT16_BIT8,0x3d81,  0x01); // load otp into buffer
	Sleep(100);
