...
{   
	...
	m_pfnGetAsicRegister = (pfn_GetAsicRegister)GetProcAddress(m_hLib, ("GetAsicRegister"));
	m_pfnSetAsicRegister = (pfn_SetAsicRegister)GetProcAddress(m_hLib, ("SetAsicRegister"));	
