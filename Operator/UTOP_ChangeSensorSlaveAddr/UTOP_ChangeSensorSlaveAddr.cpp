// UTOP_ChangeSensorSlaveAddr.cpp : 定義 DLL 的初始化常式。
//
...
// CUTOP_ChangeSensorSlaveAddrApp 建構
...
// 僅有的一個 CUTOP_ChangeSensorSlaveAddrApp 物件

CUTOP_ChangeSensorSlaveAddrApp theApp;


// CUTOP_ChangeSensorSlaveAddrApp 初始設定
