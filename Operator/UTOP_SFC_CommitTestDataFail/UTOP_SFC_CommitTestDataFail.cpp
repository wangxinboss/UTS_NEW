// UTOP_SFC_CommitTestDataFail.cpp : 定义 DLL 的初始化例程。
//
...
// CUTOP_SFC_CommitTestDataFailApp 构造
...
// 唯一的一个 CUTOP_SFC_CommitTestDataFailApp 对象

CUTOP_SFC_CommitTestDataFailApp theApp;


// CUTOP_SFC_CommitTestDataFailApp 初始化
