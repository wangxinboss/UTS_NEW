// UTOP_Resolution_MultiChart.cpp : 定義 DLL 的初始化常式。
//
...
// CUTOP_Resolution_MultiChartApp 建構
...
// 僅有的一個 CUTOP_Resolution_MultiChartApp 物件

CUTOP_Resolution_MultiChartApp theApp;


// CUTOP_Resolution_MultiChartApp 初始設定
