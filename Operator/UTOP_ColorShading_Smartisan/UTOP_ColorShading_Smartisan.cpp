// UTOP_ColorShading_Smartisan.cpp : 定義 DLL 的初始化常式。
//
...
// CUTOP_ColorShading_SmartisanApp 建構
...
// 僅有的一個 CUTOP_ColorShading_SmartisanApp 物件

CUTOP_ColorShading_SmartisanApp theApp;


// CUTOP_ColorShading_SmartisanApp 初始設定
