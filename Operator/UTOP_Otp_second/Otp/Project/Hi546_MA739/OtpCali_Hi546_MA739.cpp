...
//-------------------------------------------------------------------------------------------------
OtpCali_Hi546_MA739::OtpCali_Hi546_MA739(BaseDevice *dev) : HynixOtp(dev)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_Hi546_MA739::do_prog_otp()
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_Hi546_MA739::get_otp_data_from_sensor(void *args)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_Hi546_MA739::LscCali(void *args)
{
	return SET_ERROR(OTPCALI_ERROR_OPTNOTSUPPORT);
}
//-------------------------------------------------------------------------------------------------
int OtpCali_Hi546_MA739::get_minfo_from_db(void *args)
{
...
int OtpCali_Hi546_MA739::get_otp_data_from_db(void *args)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_Hi546_MA739::get_uniform_otp_data(void *in, void *out, int maxlen)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_Hi546_MA739::get_otp_group(void)
{
    return 0;
}
//-------------------------------------------------------------------------------------------------
