...
namespace UTS
{
    typedef struct _colorshading_operator_param_
    {
		...
		MinMax<double> stCenterRatioBGSpec;
		MinMax<double> stCenterRatioRGSpec;
		MinMax<double> stCenterRatioGrGbSpec;
		MinMax<double> stCornerRatioBGSpec;
		MinMax<double> stCornerRatioRGSpec;
    ...
    private:
        ...
        //------------------------------------------------------------------------------
        // 结果
        CS_RATIO_NOKIA_RESULT m_result;
        double m_dYvalue;
    };
