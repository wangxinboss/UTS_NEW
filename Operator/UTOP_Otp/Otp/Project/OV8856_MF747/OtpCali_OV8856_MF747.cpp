#include "StdAfx.h"
#include "OtpCali_OV8856_MF747.h"

#define OFFSETMACRO  0
#define OFFSETINF  0

namespace OtpCali_OV8856_MF747 {
//-------------------------------------------------------------------------------------------------
OtpCali_OV8856_MF747::OtpCali_OV8856_MF747(BaseDevice *dev) : OVOtp(dev)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_OV8856_MF747::do_prog_otp()
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_OV8856_MF747::get_otp_data_from_sensor(void *args)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_OV8856_MF747::LscCali(void *args)
{
	...
	ret= LenC_Cal_8858R2A_Raw8(m_bufferObj.pRaw8Buffer,m_bufferInfo.nWidth,m_bufferInfo.nHeight,lsc->cali_target,16,pLenCReg,&otp_lsc_len);
...
//-------------------------------------------------------------------------------------------------
int OtpCali_OV8856_MF747::get_minfo_from_db(void *args)
{
...
int OtpCali_OV8856_MF747::get_otp_data_from_db(void *args)
{
	OTPData *otp = (OTPData*)args;
	USES_CONVERSION;
...
//-------------------------------------------------------------------------------------------------
int OtpCali_OV8856_MF747::get_uniform_otp_data(void *in, void *out, int maxlen)
{
...
//-------------------------------------------------------------------------------------------------
int OtpCali_OV8856_MF747::get_otp_group(void)
{
    return 0;
}
//-------------------------------------------------------------------------------------------------
