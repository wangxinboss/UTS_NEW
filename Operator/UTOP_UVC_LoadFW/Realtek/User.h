...
typedef LRESULT (*pfn_EEPROMWrite)(EEPROM_ID EepromID, DWORD dwAddress, DWORD dwLength, LPBYTE pData, PfnDownloadProgressCB pfnProgressCB, ProgressInfo* progressInfo);
typedef BOOL    (*pfn_SetLEDMode)(BOOL bLedOn);
typedef BOOL    (*pfn_SetCameraStatus)(BOOL bStandBy);
typedef LRESULT (*pfn_EEPROMWriteSN)(EEPROM_ID EepromID, DWORD dwAddress, DWORD dwLength, LPBYTE pData, CString strSN, PfnDownloadProgressCB pfnProgressCB, ProgressInfo* progressInfo);
