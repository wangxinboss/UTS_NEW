// UTOP_MeasureSuspendCurrent.cpp : 定義 DLL 的初始化常式。
//
...
// CUTOP_MeasureSuspendCurrentApp 建構
...
// 僅有的一個 CUTOP_MeasureSuspendCurrentApp 物件

CUTOP_MeasureSuspendCurrentApp theApp;


// CUTOP_MeasureSuspendCurrentApp 初始設定
