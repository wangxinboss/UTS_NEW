...
namespace UTS
{
	...
	BOOL ImplOperator::OnReadSpec()
	{
		...
		uts.dbCof.GetOperatorSingleSpec(strSection, _T("DelayTime"), m_param.DelayTime, 1000, _T("Suspend delay Time"));
		uts.dbCof.GetOperatorSingleSpec(strSection, _T("nMeasureMethod"), m_param.nMeasureMethod, 0, _T("0 : NULL 1:FLUKE 2:PROVA"));
		uts.dbCof.GetOperatorSingleSpec(strSection, _T("Spec.dCurrentSpec"), strValue, _T("50,1000"), _T("CurrentSpec(Min,Max)"));
